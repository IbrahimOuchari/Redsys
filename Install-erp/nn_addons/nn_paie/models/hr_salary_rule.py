...
class HrPayrollStructure(models.Model):
    ...
    def _get_parent(self):
        return self.env.ref('nn_paie.structure_base', False)
    ...
    imposition = fields.Selection([
        ('imp', 'Imposable'),
        ('imp_fis', 'Imposable Fiscal'),
        ('non_imp', 'Non Imposable')
    ], string='Imposition', required=True, default='imp')
...
class HrSalaryRule(models.Model):
    ...
    avantage = fields.Boolean(string='Allocation Manuelle', default=False,
                                        help="Utiliser pour jouter un avantage mensuel manuellement.")
    ...
    condition_range_min = fields.Float(string='Minimum Range', digits='Payroll', help="The minimum amount, applied for this rule.")
    condition_range_max = fields.Float(string='Maximum Range', digits='Payroll', help="The maximum amount, applied for this rule.")
