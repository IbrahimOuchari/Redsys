...
class Users(models.Model):
    ...
    odoobot_state = fields.Selection(
        [
            ...
            ('idle', 'Idle'),
            ('disabled', 'Disabled'),
        ], string="Admin Status", readonly=True, required=False)  # keep track of the state: correspond to the code of the last message sent
    ...
    def _init_odoobot(self):
        ...
        message = Markup("%s<br/>%s<br/><b>%s</b> <span class=\"o_odoobot_command\">:)</span>") % (
            _("Hello,"),
            _("Chat helps employees collaborate efficiently. I'm here to help you discover its features."),
