...
class SaleOrderOption(models.Model):
    ...
    order_id = fields.Many2one('sale.quotation', 'Quotations Order Reference', ondelete='cascade', index=True)
    ...
    line_id = fields.Many2one(
        comodel_name='sale.quotation.line', ondelete='set null', copy=False)
    ...
    def _compute_price_unit(self):
        for option in self:
            ...
            new_sol = self.env['sale.quotation.line'].new(values)
    ...
    def add_option_to_order(self):
        ...
        order_line = self.env['sale.quotation.line'].create(values)
